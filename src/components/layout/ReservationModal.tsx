...
const ReservationModal = ({ isOpen, onClose }: ReservationModalProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="bg-white rounded-xl shadow-xl relative w-full max-w-3xl overflow-hidden">
        {/* Header */}
        ...
        <div className="grid grid-cols-2 gap-4 p-6 bg-gray-50">
          <button 
            onClick={onClose}
            className="py-3 text-gray-700 font-medium border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors"
          >
            Cancel
          </button>
          <button 
