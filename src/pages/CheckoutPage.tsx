      ...
      <div className="min-h-screen flex flex-col bg-gray-50">
        ...
        <main className="flex-grow flex items-center justify-center">
          <div className="text-center p-6 max-w-md">
            ...
            <button 
              onClick={() => navigate("/")}
              className="bg-foodyman-lime text-white font-medium py-3 px-6 rounded-md"
            >
              Explore Menu
            </button>
          </div>
              ...
              <div className="bg-white rounded-lg shadow p-4 md:p-6 mb-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    <MapPin className="text-foodyman-lime mt-1 mr-3" size={20} />
                    <div>
                      <h3 className="font-medium">Delivery Address</h3>
                      <p className="text-gray-600">San Francisco 14 St.</p>
                      <button className="text-foodyman-lime text-sm mt-1">Change</button>
                    </div>
                  </div>
                  
                  <div className="flex items-start">
                    <Clock className="text-foodyman-lime mt-1 mr-3" size={20} />
                    <div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-lg shadow p-4 md:p-6 mb-6 sticky top-6">
                ...
                <div className="space-y-3">
                  <label className="flex items-center p-3 border rounded-lg cursor-pointer transition-colors hover:bg-gray-50">
                    ...
                    <div className={`w-5 h-5 rounded-full border flex items-center justify-center ${
                      paymentMethod === "card" ? "border-foodyman-lime" : "border-gray-300"
                    }`}>
                      {paymentMethod === "card" && (
                        <div className="w-3 h-3 rounded-full bg-foodyman-lime"></div>
                      )}
                    </div>
                  ...
                  <label className="flex items-center p-3 border rounded-lg cursor-pointer transition-colors hover:bg-gray-50">
                    ...
                    />
                    <div className={`w-5 h-5 rounded-full border flex items-center justify-center ${
                      paymentMethod === "cash" ? "border-foodyman-lime" : "border-gray-300"
                    }`}>
                      {paymentMethod === "cash" && (
                        <div className="w-3 h-3 rounded-full bg-foodyman-lime"></div>
                      )}
                  ...
                  <div className="mt-4 space-y-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-1 focus:ring-foodyman-lime"
                      />
                    </div>
                ...
                <button 
                  ...
                  className="w-full mt-6 bg-foodyman-lime text-white font-medium py-3 rounded-md flex items-center justify-center"
                >
