    ...
    <div className={`relative address-input-container ${className}`}>
      <div className="relative">
        <input
          ...
          disabled={disabled}
          className="w-full px-4 py-2.5 pl-12 bg-neutral-50 border border-neutral-200 rounded-xl focus:ring-2 focus:ring-yellow-600 focus:border-transparent disabled:opacity-50"
        />
